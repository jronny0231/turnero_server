...
const controller = __importStar(require("../controllers/client.controller"));
...
router.post('/', middlewares, (0, validation_middlewares_1.default)(client_schema_1.createClient), controller.StoreNewClient);
router.put('/', middlewares, (0, validation_middlewares_1.default)(client_schema_1.updateClient), controller.UpdateClient);
