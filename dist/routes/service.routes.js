...
router.post('/groups/', middlewares, (0, validation_middlewares_1.default)(service_schema_1.createServicesGroup), groupCtl.StoreNewServiceGroup);
router.put('/groups/:id', middlewares, (0, validation_middlewares_1.default)(service_schema_1.updateServiceGroup), groupCtl.UpdateServiceGroup);
